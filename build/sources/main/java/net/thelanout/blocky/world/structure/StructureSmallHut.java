...
package net.thelanout.blocky.world.structure;
...
public class StructureSmallHut extends ElementsBlocky.ModElement {
	public StructureSmallHut(ElementsBlocky instance) {
		super(instance, 6);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 10000) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("blocky", "smallhut"));
				if (template == null)
					return;
